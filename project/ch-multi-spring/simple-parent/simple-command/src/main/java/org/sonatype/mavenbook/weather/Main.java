...
public class Main {
	...
	/*
		...
		System.out.println("current weather condition for :" +weather.getLocation().getCity() + " , " + weather.getLocation().getRegion()
				+ " ," + weather.getLocation().getRegion());
		System.out.println("Temperature : " + weather.getCondition().getTemp());
		System.out.println("Condition :" +weather.getCondition().getText());
		System.out.println("Humidity: " + weather.getAtmosphere().getHumidity());
		System.out.println("Wind-Chill : "+ weather.getWind().getChill());
